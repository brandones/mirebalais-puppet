class openmrs (
    ...
    #Feature_toggles
    $registerTestPatient = hiera('register_test_patient'),
    $notifiableDiseasesReport = hiera('notifiable_diseases_report'),
    $reportingui_adHocAnalysis = hiera('reportingui_ad_hoc_analysis'),
    $radiologyContrastStudies = hiera('radiology_contrast_studies'),
    $deathNote = hiera('death_note'),
    $appointmentscheduling_confidential= hiera('appointmentscheduling_confidential'),
    $receiptNumber = hiera('receipt_number'),
    $insuranceCollection = hiera('insurance_collection'),
    $primaryCareNote = hiera('primary_care_note'),
    $relationships = hiera('relationships'),
    $programsList = hiera('programs_list'),
    $zika = hiera('zika'),
    $hiv = hiera('hiv'),
    $vct = hiera('vct'),
    $patientDocuments = hiera('patient_documents'),
    $additionalHaitiIdentifiers = hiera('additional_haiti_identifiers'),
    $chwApp = hiera('chw_mgmt_app'),
    $ncdProgram = hiera('ncd_program'),
    $labTracking = hiera('lab_tracking'),
    $conditionList = hiera('condition_list'),
